...
function create() {
	...
	game.physics.startSystem(Phaser.Physics.ARCADE);
		//game.physics.arcade.gravity.y = 100; //pongo la gravedad a 100 al mundo
	...
	game.physics.enable(player, Phaser.Physics.ARCADE);
		//player.body.allowGravity = true; //quito la gravedad al jugador
	...
	game.physics.enable(food, Phaser.Physics.ARCADE);
		//for (var i in food.children) {
		//	food.children[i].body.collideWorldBounds=true;
		//}
