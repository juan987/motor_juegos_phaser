...
function update() {
	...
	if (maximoKoopas>koopasActuales){
		...
		if (currentDate.getTime() > (fechaUltimoKoopa.getTime()+3000)){
			...
			koopas.children[koopas.children.length-1].body.collideWorldBounds = true;
			koopasActuales++;
			//podríamos haber usado koopas.setAll('body.collideWorldBounds', true); pero no tiene mucho sentido al ir de 1 en 1
		}
	}
